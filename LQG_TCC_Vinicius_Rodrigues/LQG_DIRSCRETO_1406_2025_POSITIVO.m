...
% =========================================================================
% SCRIPT: LQG_Discreto_POSITIVO.m
...
% Carregar Dados
dados = load('Druffarel_Campo-positivo.txt');
...
Ts = 0.02;
%============================== REGIAO 1 ==================================
tfz_rd_30 = EncontraTFz(rpm_rd_30,30,t,Ts);
[numz_30,denz_30] = tfdata(tfz_rd_30,'v');

tfz_rd_40 = EncontraTFz(rpm_rd_40,40,t,Ts);
[numz_40,denz_40] = tfdata(tfz_rd_40,'v');

tfz_rd_50 = EncontraTFz(rpm_rd_50,50,t,Ts);
...
%============================== REGIAO 2 ==================================
tfz_rd_60 = EncontraTFz(rpm_rd_60,60,t,Ts);
[numz_60,denz_60] = tfdata(tfz_rd_60,'v');

tfz_rd_70 = EncontraTFz(rpm_rd_70,70,t,Ts);
[numz_70,denz_70] = tfdata(tfz_rd_70,'v');

tfz_rd_80 = EncontraTFz(rpm_rd_80,80,t,Ts);
...
%============================== REGIAO 3 ==================================
tfz_rd_90 = EncontraTFz(rpm_rd_90,90,t,Ts);
[numz_90,denz_90] = tfdata(tfz_rd_90,'v');

tfz_rd_100 = EncontraTFz(rpm_rd_100,100,t,Ts);
...
Ts = 0.020;
%============================== REGIAO 1 ==================================
tfz_re_30 = EncontraTFz(rpm_re_30,30,t,Ts);
[numz_30,denz_30] = tfdata(tfz_re_30,'v');

tfz_re_40 = EncontraTFz(rpm_re_40,40,t,Ts);
[numz_40,denz_40] = tfdata(tfz_re_40,'v');

tfz_re_50 = EncontraTFz(rpm_re_50,50,t,Ts);
...
%============================== REGIAO 2 ==================================
tfz_re_60 = EncontraTFz(rpm_re_60,60,t,Ts);
[numz_60,denz_60] = tfdata(tfz_re_60,'v');

tfz_re_70 = EncontraTFz(rpm_re_70,70,t,Ts);
[numz_70,denz_70] = tfdata(tfz_re_70,'v');

tfz_re_80 = EncontraTFz(rpm_re_80,80,t,Ts);
...
%============================== REGIAO 3 ==================================
tfz_re_90 = EncontraTFz(rpm_re_90,90,t,Ts);
[numz_90,denz_90] = tfdata(tfz_re_90,'v');

tfz_re_100 = EncontraTFz(rpm_re_100,100,t,Ts);
...
par1 = 0.08;% Atua na retroação da velocidade, quanto mais alto o parâmetro maior o tempo de acomodação.
par2 = 25;  % Atua na integração, quanto maior o paramêtro mais rápido erro nulo em regime permanente.
Q1 = [par1 0;0 par2];
...
% Matrizes de ponderação Q e R
par1 = 0.4; % Atua na retroação da velocidade, quanto mais alto o parâmetro maior o tempo de acomodação.
...
% Matrizes de ponderação Q e R
par1 = 0.6; % Atua na retroação da velocidade, quanto mais alto o parâmetro maior o tempo de acomodação.
par2 = 30; % Atua na integração, quanto maior o paramêtro mais rápido erro nulo em regime permanente.
Q3 = [par1 0;0 par2];
...
% Matrizes de ponderação Q e R
par1 = 0.2; % Atua na retroação da velocidade, quanto mais alto o parâmetro maior o tempo de acomodação.
par2 = 30; % Atua na integração, quanto maior o paramêtro mais rápido erro nulo em regime permanente.
Q1 = [par1 0;0 par2];
R1 = 2; % Atua no esforço de controle, quanto maior mais lenta e amortecida a dinâmica do sistema.

[xiz1,Kchz1,Lchz1,INFO] = idare(Aex_re1, Bex_re1, Q1, R1); 
...
% Matrizes de ponderação Q e R
par1 = 0.5; % Atua na retroação da velocidade, quanto maior o parâmetro maior o tempo de acomodação.
par2 = 20; % Atua na integração, quanto maior o paramêtro mais rápido erro nulo em regime permanente.
Q3 = [par1 0;0 par2];
R3 = 2; % Atua no esforço de controle, quanto maior mais lenta e amortecida a dinâmica do sistema.

[xiz3,Kchz3,Lchz2] = idare(Aex_re3, Bex_re3, Q3, R3); 
...
fprintf('float Ki_Dir_pos[3] = {%2.4f, %2.4f, %2.4f}; \n',abs(Ki_rd1),abs(Ki_rd2),abs(Ki_rd3));
fprintf('float K1_Dir_pos[3] = {%2.4f, %2.4f, %2.4f}; \n',abs(K1_rd1),abs(K1_rd2),abs(K1_rd3));

fprintf('\nfloat Ki_Esq_pos[3] = {%2.4f, %2.4f, %2.4f}; \n',abs(Ki_re1),abs(Ki_re2),abs(Ki_re3));
fprintf('float K1_Esq_pos[3] = {%2.4f, %2.4f, %2.4f}; \n',abs(K1_re1),abs(K1_re2),abs(K1_re3));
